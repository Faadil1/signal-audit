/* ==========================================================================
   SignalAudit — The Standing Order
   ...
   Motion is deliberately slow (600-900ms) — restraint is the message.
   ========================================================================== */
...
(function () {
  ...
  var SCENARIOS = {
    abort: {
      ...
      rationale: "The order holds. No action permitted. FLAG_003 is CRITICAL and NT conditions are active \u2014 the conditions written in advance were not met, so nothing proceeds.",
    ...
    proceed: {
      ...
      rationale: "Conditions met. Proceed exactly as written. All signals cited in the order are clear \u2014 nothing was improvised, nothing was decided in the moment.",
  ...
  // ---------------------------------------------------------------------
  // Sequencing — slow, deliberate. Two beats only: seal-break, then fold open.
  // ---------------------------------------------------------------------
